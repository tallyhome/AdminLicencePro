                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                                   id="name" name="name" placeholder="Votre nom complet" value="{{ old('name') }}" required>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('subject') is-invalid @enderror" 
                                                   id="subject" name="subject" placeholder="Sujet de votre demande" value="{{ old('subject') }}" required>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card border-0 shadow-sm h-100 text-center">
                        <div class="card-body p-4">
                            ...
                            <a href="{{ route('frontend.support') }}" class="btn btn-outline-primary">
                                Centre de Support
                            </a>
                        </div>
                    </div>
    ...
    <section class="section-professional bg-white">
        <div class="container">
            ...
            <div class="text-center mt-5">
                <a href="{{ route('frontend.faqs') }}" class="btn btn-primary-professional me-3">
                    <span class="me-2">❓</span>Voir toutes les FAQs
                </a>
                <a href="{{ route('frontend.pricing') }}" class="btn btn-secondary-professional">
