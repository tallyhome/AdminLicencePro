        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('frontend.features') }}">Fonctionnalités</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('frontend.pricing') }}">Tarifs</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('frontend.about') }}">À propos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('frontend.faqs') }}">FAQ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('frontend.contact') }}">Contact</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('frontend.support') }}">Support</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{ route('frontend.home') }}" class="text-light text-decoration-none">Fonctionnalités</a></li>
                        <li><a href="{{ route('frontend.about') }}" class="text-light text-decoration-none">À propos</a></li>
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{ route('frontend.contact') }}" class="text-light text-decoration-none">Contact</a></li>
