        ...
        <div class="col-12">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{ route('frontend.home') }}?preview=1" target="_blank" class="btn btn-success btn-sm">
                        <i class="fas fa-eye me-1"></i> Prévisualiser
                    </a>
                    <a href="{{ route('admin.cms.settings') }}" class="btn btn-primary btn-sm">
            ...
            <div class="card h-100 border-0 text-white" style="background: linear-gradient(135deg, #4285f4 0%, #3367d6 100%);">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="h4 mb-0 fw-bold">{{ $stats['features'] ?? 0 }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100 border-0 text-white" style="background: linear-gradient(135deg, #9c27b0 0%, #7b1fa2 100%);">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="h4 mb-0 fw-bold">{{ $stats['testimonials'] ?? 0 }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100 border-0 text-white" style="background: linear-gradient(135deg, #34a853 0%, #2d7d32 100%);">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="h4 mb-0 fw-bold">{{ $stats['faqs'] ?? 0 }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100 border-0 text-white" style="background: linear-gradient(135deg, #ff9800 0%, #f57400 100%);">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="h4 mb-0 fw-bold">{{ $stats['about_sections'] ?? 0 }}</div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                            <div class="card h-100 border-0 hover-lift" style="background: linear-gradient(135deg, #e8f5e8 0%, #f0f8f0 100%);">
                                <div class="card-body p-4 text-center">
                                    ...
                                    <a href="{{ route('admin.cms.settings') }}" class="btn btn-success">
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                            <div class="card h-100 border-0 hover-lift" style="background: linear-gradient(135deg, #e3f2fd 0%, #f3e5f5 100%);">
                                <div class="card-body p-4 text-center">
                                    ...
                                    <a href="{{ route('admin.cms.features.index') }}" class="btn btn-primary">
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                            <div class="card h-100 border-0 hover-lift" style="background: linear-gradient(135deg, #f3e5f5 0%, #fce4ec 100%);">
                                <div class="card-body p-4 text-center">
                                    ...
                                    <a href="{{ route('admin.cms.testimonials.index') }}" class="btn btn-info">
                                        <i class="fas fa-cog me-1"></i> Gérer
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                            <div class="card h-100 border-0 hover-lift" style="background: linear-gradient(135deg, #fff3e0 0%, #fce4ec 100%);">
                                <div class="card-body p-4 text-center">
                                    ...
                                    <a href="{{ route('admin.cms.faqs.index') }}" class="btn btn-warning">
                                        <i class="fas fa-cog me-1"></i> Gérer
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                            <div class="card h-100 border-0 hover-lift" style="background: linear-gradient(135deg, #ffe0b2 0%, #ffcc80 100%);">
                                <div class="card-body p-4 text-center">
                                    ...
                                    <a href="{{ route('admin.cms.about.index') }}" class="btn btn-primary">
                                        <i class="fas fa-cog me-1"></i> Gérer
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                            <div class="card h-100 border-0 hover-lift" style="background: linear-gradient(135deg, #f0f0f0 0%, #e0e0e0 100%);">
                                <div class="card-body p-4 text-center">
                                    ...
                                    <a href="{{ route('admin.cms.templates') }}" class="btn btn-dark">
                ...
                <div class="card-body pt-3">
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-md-4 text-center mb-3 mb-md-0">
                            <div class="bg-{{ $current['color'] }} bg-gradient rounded d-flex align-items-center justify-content-center shadow-sm" style="height: 120px;">
                                <i class="{{ $current['icon'] }} fa-3x text-white"></i>
                            </div>
                        </div>
                        <div class="col-12 col-md-8">
                            <h5 class="fw-bold mb-2">{{ $current['name'] }}</h5>
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                ...
                                <a href="{{ route('admin.cms.templates') }}" class="btn btn-primary btn-sm">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body pt-3">
                    <div class="d-grid gap-2">
                        <a href="{{ route('admin.cms.settings') }}" class="btn btn-outline-primary btn-sm d-flex align-items-center">
                            <i class="fas fa-cogs me-2"></i>
                            Paramètres Généraux
                        </a>
                        <a href="{{ route('admin.cms.templates') }}" class="btn btn-outline-success btn-sm d-flex align-items-center">
                            <i class="fas fa-paint-brush me-2"></i>
                            Gestion Templates
                        </a>
                        <a href="{{ route('frontend.home') }}" target="_blank" class="btn btn-outline-info btn-sm d-flex align-items-center">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body pt-3">
                    <div class="row g-4">
                        <div class="col-md-4">
                            <a href="{{ route('admin.cms.settings') }}" class="text-decoration-none">
                        ...
                        <div class="col-md-4">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('admin.cms.features.index') }}">
                                        <i class="fas fa-star me-2 text-primary"></i> Fonctionnalités
                                    </a></li>
                                    <li><a class="dropdown-item" href="{{ route('admin.cms.testimonials.index') }}">
                                        <i class="fas fa-comments me-2 text-info"></i> Témoignages
                                    </a></li>
                                    <li><a class="dropdown-item" href="{{ route('admin.cms.faqs.index') }}">
                                        <i class="fas fa-question-circle me-2 text-warning"></i> FAQs
                                    </a></li>
                                    <li><a class="dropdown-item" href="{{ route('admin.cms.about.index') }}">
                        ...
                        <div class="col-md-4">
                            <a href="{{ route('admin.cms.templates') }}" class="text-decoration-none">
                                <div class="text-center p-3 border rounded hover-lift h-100">
