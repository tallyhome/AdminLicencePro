...
@section('title', 'CMS - Gestion du Site')
        ...
        <div class="col-12">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{ route('admin.cms.preview') }}" target="_blank" class="btn btn-success btn-sm">
                        <i class="fas fa-eye me-1"></i> Prévisualiser
                    </a>
                    @if($stats['features'] == 0 && $stats['faqs'] == 0)
                    <form action="{{ route('admin.cms.initialize') }}" method="POST" class="d-inline">
                        @csrf
            ...
            <div class="card h-100 border-0 text-white" style="background: linear-gradient(135deg, #4285f4 0%, #3367d6 100%);">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="h4 mb-0 fw-bold">{{ $stats['features'] }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100 border-0 text-white" style="background: linear-gradient(135deg, #34a853 0%, #2d7d32 100%);">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="h4 mb-0 fw-bold">{{ $stats['faqs'] }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100 border-0 text-white" style="background: linear-gradient(135deg, #9c27b0 0%, #7b1fa2 100%);">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="h4 mb-0 fw-bold">{{ $stats['testimonials'] }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100 border-0 text-white" style="background: linear-gradient(135deg, #ff9800 0%, #f57400 100%);">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="h4 mb-0 fw-bold">{{ $stats['about_sections'] }}</div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                            <div class="card h-100 border-0 hover-lift" style="background: linear-gradient(135deg, #e8f5e8 0%, #f0f8f0 100%);">
                                <div class="card-body p-4 text-center">
                                    ...
                                    <a href="{{ route('admin.cms.faqs.index') }}" class="btn btn-success">
                                        <i class="fas fa-cog me-1"></i> Gérer
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                            <div class="card h-100 border-0 hover-lift" style="background: linear-gradient(135deg, #fff3e0 0%, #fce4ec 100%);">
                                <div class="card-body p-4 text-center">
                                    ...
                                    <a href="{{ route('admin.cms.about.index') }}" class="btn btn-warning">
                                        <i class="fas fa-cog me-1"></i> Gérer
                                    </a>
                                </div>
                            </div>
                    ...
                    @if($currentTemplate)
                        <div class="row align-items-center">
                            <div class="col-12 col-md-4 text-center mb-3 mb-md-0">
                                @if($currentTemplate->preview_image)
                                    <img src="{{ $currentTemplate->preview_image }}" alt="{{ $currentTemplate->display_name }}" 
                            ...
                            <div class="col-12 col-md-8">
                                <h5 class="fw-bold mb-2">{{ $currentTemplate->display_name }}</h5>
                                <p class="text-muted mb-3">{{ $currentTemplate->description }}</p>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body pt-3">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('admin.cms.preview') }}" target="_blank" class="btn btn-outline-info btn-sm d-flex align-items-center">
