    ...
    <div class="sidebar text-white">
        ...
        <nav class="sidebar-nav">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('client.licenses.*') ? 'active' : '' }}" href="{{ route('client.licenses.index') }}">
                        <i class="fas fa-key"></i>
                        Licences
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('client.analytics.*') ? 'active' : '' }}" href="{{ route('client.analytics.index') }}">
                        <i class="fas fa-chart-line"></i>
                        Analytics
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('client.support.*') ? 'active' : '' }}" href="{{ route('client.support.index') }}">
                        <i class="fas fa-life-ring"></i>
                        Support
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('client.billing.*') ? 'active' : '' }}" href="{{ route('client.billing.index') }}">
                        <i class="fas fa-credit-card"></i>
                        Facturation
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('client.settings.*') ? 'active' : '' }}" href="{{ route('client.settings.index') }}">
        ...
        <div class="mt-auto p-3">
            ...
            <div class="d-flex align-items-center mb-3">
                ...
                <div>
                    <div class="fw-semibold">{{ auth('client')->user()->name }}</div>
                    <small class="opacity-75">{{ auth('client')->user()->email }}</small>
                </div>
            </div>

            @if($subscription = auth('client')->user()->tenant->subscriptions()->latest()->first())
                <div class="mb-3">
