...
<body>
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('client.projects.index') }}">
                        ...
                        Projets
                        <span class="badge bg-light text-dark ms-auto">{{ $usageStats['projects']['count'] }}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('client.licenses.index') }}">
                        ...
                        Licences
                        <span class="badge bg-light text-dark ms-auto">{{ $usageStats['licenses']['count'] }}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('client.analytics.index') }}">
            ...
            <div class="mt-auto p-3">
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <small>Plan {{ $subscription->plan->name ?? 'Inconnu' }}</small>
        ...
        <div class="container-fluid p-4">
                    ...
                    <div class="welcome-card card">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h2 class="mb-2">Bienvenue, {{ $client->name }} ! 👋</h2>
                                    <p class="mb-0 opacity-90">
                                        Voici un aperçu de votre activité pour {{ $tenant->name }}
                                    </p>
                                </div>
                                <div class="text-end">
                                    <div class="h5 mb-1">{{ now()->format('d M Y') }}</div>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <div class="notification-card notification-{{ $notification['type'] }} card">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    ...
                                    <small class="text-muted">sur {{ $usageStats['projects']['limit'] }} autorisés</small>
                                    @else
                            ...
                            <div class="mt-3">
                                <div class="progress" style="height: 6px;">
                                    <div class="progress-bar bg-primary" 
                                         style="width: {{ $usageStats['projects']['percentage'] }}%"></div>
                                </div>
                                <small class="text-muted">{{ $usageStats['projects']['percentage'] }}% utilisé</small>
                            </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    ...
                                    <small class="text-muted">sur {{ $usageStats['licenses']['limit'] }} autorisées</small>
                                    @else
                                    <small class="text-success">Illimité</small>
                                    @endif
                                </div>
                            ...
                            <div class="mt-3">
                                <div class="progress" style="height: 6px;">
                                    <div class="progress-bar bg-success" 
                                         style="width: {{ $usageStats['licenses']['percentage'] }}%"></div>
                                </div>
                                <small class="text-muted">{{ $usageStats['licenses']['percentage'] }}% utilisé</small>
                            </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    ...
                                    <h3 class="mb-1">{{ $usageStats['active_licenses'] }}</h3>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    ...
                                    <h3 class="mb-1">{{ $usageStats['total_activations'] }}</h3>
                    ...
                    <div class="card card-stats">
                        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 fw-semibold text-primary">
                                ...
                                Projets Récents
                                                         ...
                                                         <a href="{{ route('client.projects.create') }}" class="btn btn-sm btn-gradient">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="activity-item d-flex align-items-center">
                                ...
                                <span class="badge badge-status bg-{{ $project->status === 'active' ? 'success' : 'secondary' }}">
                    ...
                    <div class="card card-stats">
                        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 fw-semibold text-primary">
                                ...
                                Licences Récentes
                                                         ...
                                                         <a href="{{ route('client.licenses.create') }}" class="btn btn-sm btn-gradient">
                                 <i class="fas fa-plus me-1"></i>
                                 Nouvelle licence
                             </a>
                        </div>
                        <div class="card-body p-0">
                            ...
                            <div class="activity-item d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <div class="fw-semibold">{{ $license->serial_key }}</div>
                                    <small class="text-muted">
                                        {{ $license->project->name ?? 'Projet inconnu' }} • 
                                        {{ $license->created_at->diffForHumans() }}
                                    </small>
                                </div>
                                <span class="badge badge-status bg-{{ $license->status === 'active' ? 'success' : ($license->status === 'inactive' ? 'secondary' : 'warning') }}">
    ...
    <script>
        ...
        const licensesChart = new Chart(ctx, {
            type: 'line',
            data: {
                labels: {!! json_encode($chartsData['labels'] ?? []) !!},
                datasets: [{
                    label: 'Licences créées',
                    data: {!! json_encode($chartsData['data'] ?? []) !!},
                    borderColor: '#667eea',
        ...
        function updateChart(period) {
            fetch(`{{ route('client.dashboard') }}/chart-data?period=${period}`)
