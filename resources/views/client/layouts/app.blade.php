    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('client.projects.*') ? 'active' : '' }}" 
                       href="{{ route('client.projects.index') }}">
                        ...
                        Projets
                        @if(isset($usageStats) && isset($usageStats['projects']))
                        <span class="badge bg-light text-dark ms-auto">{{ $usageStats['projects']['count'] }}</span>
                        @endif
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('client.licenses.*') ? 'active' : '' }}" 
                       href="{{ route('client.licenses.index') }}">
                        <i class="fas fa-key"></i>
                        Licences
                        @if(isset($usageStats) && isset($usageStats['licenses']))
                        <span class="badge bg-light text-dark ms-auto">{{ $usageStats['licenses']['count'] }}</span>
                        @endif
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('client.analytics.*') ? 'active' : '' }}" 
                       href="{{ route('client.analytics.index') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('client.billing.*') ? 'active' : '' }}" 
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('client.settings.*') ? 'active' : '' }}" 
        ...
        <div class="user-section">
            <div class="user-info">
                <div class="user-avatar">
                    @if(Auth::guard('client')->user()->avatar)
                        <img src="{{ Storage::url(Auth::guard('client')->user()->avatar) }}" 
                ...
                <div class="user-details">
                    <div class="user-name">{{ Auth::guard('client')->user()->name ?? Auth::guard('client')->user()->email }}</div>
                    <div class="user-email">{{ Auth::guard('client')->user()->email }}</div>
                </div>
            </div>
            ...
            <div class="mb-3">
                <div class="d-flex justify-content-between align-items-center mb-1">
                    <small class="text-white-50">Plan {{ $subscription->plan->name ?? 'Inconnu' }}</small>
