...
<div class="container-fluid py-4">
  ...
  "domain": "example.com"
                                    ...
                                    <p>Consultez la <a href="{{ route('client.support.documentation') }}">documentation complète</a> pour plus de détails.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="tech1" class="accordion-collapse collapse" data-bs-parent="#technicalAccordion">
                                <div class="accordion-body">
                                    ...
                                    <p>Si le problème persiste, <a href="{{ route('client.support.create') }}">contactez notre support</a>.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="billing3" class="accordion-collapse collapse" data-bs-parent="#billingAccordion">
                                <div class="accordion-body">
                                    ...
                                    <p>Si le problème persiste, <a href="{{ route('client.support.create') }}">contactez notre équipe</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card bg-light">
                <div class="card-body text-center">
                    ...
                    <div class="d-flex gap-2 justify-content-center">
                        ...
                        <a href="{{ route('client.support.documentation') }}" class="btn btn-outline-primary">
