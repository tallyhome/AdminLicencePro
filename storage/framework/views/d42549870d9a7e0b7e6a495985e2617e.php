        ...
        <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
            ...
            <div>
                <ul class="pagination">
                    ...
                    <?php else: ?>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo e($paginator->previousPageUrl()); ?>" rel="prev" aria-label="<?php echo app('translator')->get('pagination.previous'); ?>"><i class="fas fa-chevron-left"></i></a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if($paginator->hasMorePages()): ?>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo e($paginator->nextPageUrl()); ?>" rel="next" aria-label="<?php echo app('translator')->get('pagination.next'); ?>"><i class="fas fa-chevron-right"></i></a>
                        </li>
                    <?php else: ?>
...
<?php endif; ?>
<?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\vendor\pagination\bootstrap-5.blade.php ENDPATH**/ ?>