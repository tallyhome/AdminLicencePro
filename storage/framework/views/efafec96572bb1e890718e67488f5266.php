...
console.log('Données des projets:', <?php echo json_encode($chartData['projects'] ?? []); ?>);
...
console.log('ProjectsData content:', projectsData);
        ...
        projectsChart = new Chart(projectsCtx, {
            ...
            plugins: [{
                beforeDraw: function(chart) {
                    ...
                    ctx.fillText('Aucune activation', width / 2, height / 2);
                    ctx.save();
                }
            }]
        });
...
// Initialisation Bootstrap dropdowns pour Bootstrap 5
document.addEventListener('DOMContentLoaded', function() {
    // Les dropdowns Bootstrap 5 s'initialisent automatiquement
