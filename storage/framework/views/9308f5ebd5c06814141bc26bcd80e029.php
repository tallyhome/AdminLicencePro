...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <!-- Domaine -->
                        <div class="mb-3">
                            <label for="domain" class="form-label"><?php echo e(t('serial_keys.domain_optional')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Adresse IP -->
                        <div class="mb-3">
                            <label for="ip_address" class="form-label"><?php echo e(t('serial_keys.ip_address_optional')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Date d'expiration -->
                        <div class="mb-3">
                            <label for="expires_at" class="form-label"><?php echo e(t('serial_keys.expiration_date_optional')); ?></label>
