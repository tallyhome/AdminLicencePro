            ...
            <div class="card bg-primary text-white">
                <div class="card-body p-5">
                    ...
                    <div class="d-flex gap-3 justify-content-center flex-wrap">
                        <a href="<?php echo e(route('frontend.contact')); ?>" class="btn btn-light btn-lg">
                            <span class="me-2">📧</span>Nous Contacter
                        </a>
                        <a href="<?php echo e(route('frontend.pricing')); ?>" class="btn btn-outline-light btn-lg">
...
<?php echo $__env->make($layout ?? 'frontend.templates.modern.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\frontend\pages\features.blade.php ENDPATH**/ ?>