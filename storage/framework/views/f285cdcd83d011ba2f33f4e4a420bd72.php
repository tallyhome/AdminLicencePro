    ...
    <div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md text-center text-sm text-gray-600">
            <div class="flex justify-between items-center">
                ...
                <div>
                    <span><?php echo e(config('app.name', 'AdminLicence')); ?> v<?php echo e(\App\Helpers\VersionHelper::getFullVersion()); ?></span>
                </div>
            </div>
        </div>
    </div>
</body>
</html><?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\install\layout.blade.php ENDPATH**/ ?>