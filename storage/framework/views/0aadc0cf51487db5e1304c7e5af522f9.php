...
<?php $__env->startSection('title', 'Nouveau Témoignage'); ?>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.cms.testimonials.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                          id="content" name="content" rows="5" required><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-end">
                            <a href="<?php echo e(route('admin.cms.testimonials.index')); ?>" class="btn btn-light me-2">Annuler</a>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\admin\cms\testimonials\create.blade.php ENDPATH**/ ?>