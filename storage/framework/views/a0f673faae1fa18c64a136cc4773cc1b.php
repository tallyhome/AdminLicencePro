            ...
            <section id="introduction" class="mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h6>URL de Base</h6>
                        <pre><code><?php echo e(url('/api/v1')); ?></code></pre>
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, '<?php echo e(url('/api/v1/validate')); ?>');
...
?&gt;</code></pre>
    ...
    try {
        const response = await fetch('<?php echo e(url('/api/v1/validate')); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
...
def validate_license(api_key, license_key, domain):
    url = '<?php echo e(url('/api/v1/validate')); ?>'
...
validate_license('votre_cle_api', 'XXXX-XXXX-XXXX-XXXX', 'example.com')</code></pre>
                            ...
                            <div class="tab-pane fade" id="curl" role="tabpanel">
                                <pre><code>curl -X POST <?php echo e(url('/api/v1/validate')); ?> \
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\client\support\documentation.blade.php ENDPATH**/ ?>