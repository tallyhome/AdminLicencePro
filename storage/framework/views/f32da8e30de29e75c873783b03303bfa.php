                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="card template-card <?php echo e($currentTemplateName === 'modern' ? 'border-primary' : ''); ?>">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <?php if($currentTemplateName === 'modern'): ?>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <a href="<?php echo e(route('frontend.home')); ?>?template=modern&preview=1" target="_blank" class="btn btn-outline-primary btn-sm">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="card template-card <?php echo e($currentTemplateName === 'professional' ? 'border-primary' : ''); ?>">
                                <div class="template-preview">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <?php if($currentTemplateName === 'professional'): ?>
                                            <span class="badge bg-primary">Actuel</span>
                                        <?php else: ?>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <a href="<?php echo e(route('frontend.home')); ?>?template=professional&preview=1" target="_blank" class="btn btn-outline-primary btn-sm">
                                            <i class="fas fa-eye"></i> Prévisualiser
                                        </a>
                                        <?php if($currentTemplateName === 'professional'): ?>
                                            <button class="btn btn-primary btn-sm" disabled>
