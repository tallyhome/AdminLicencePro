    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo e(route('admin.serial-keys.index')); ?>" class="btn btn-primary">Voir toutes les clés</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="projectsModal" tabindex="-1" aria-labelledby="projectsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                <a href="<?php echo e(route('admin.projects.index')); ?>" class="btn btn-success">Voir tous les projets</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="activeKeysModal" tabindex="-1" aria-labelledby="activeKeysModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                <a href="<?php echo e(route('admin.serial-keys.index')); ?>?status=active" class="btn btn-info">Voir toutes les clés actives</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="apiKeysModal" tabindex="-1" aria-labelledby="apiKeysModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                <a href="<?php echo e(route('admin.api-keys.index')); ?>" class="btn btn-dark">Voir toutes les clés API</a>
            </div>
        </div>
    </div>
</div>
<?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\admin\settings\api-diagnostic-modals.blade.php ENDPATH**/ ?>