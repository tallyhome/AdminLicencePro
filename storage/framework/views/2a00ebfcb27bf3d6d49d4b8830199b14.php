...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-professional fixed-top">
        <div class="container">
            <a class="navbar-brand-professional" href="<?php echo e(route('frontend.home')); ?>">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link-professional" href="<?php echo e(route('frontend.home')); ?>"><?php echo e($settings['nav_home_text'] ?? 'Accueil'); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link-professional" href="<?php echo e(route('frontend.features')); ?>"><?php echo e($settings['nav_features_text'] ?? 'Fonctionnalités'); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link-professional" href="<?php echo e(route('frontend.pricing')); ?>"><?php echo e($settings['nav_pricing_text'] ?? 'Tarifs'); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link-professional" href="<?php echo e(route('frontend.about')); ?>"><?php echo e($settings['nav_about_text'] ?? 'À propos'); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link-professional" href="<?php echo e(route('frontend.faqs')); ?>"><?php echo e($settings['nav_faq_text'] ?? 'FAQ'); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link-professional" href="<?php echo e(route('frontend.contact')); ?>"><?php echo e($settings['nav_contact_text'] ?? 'Contact'); ?></a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <h5 class="mb-0 text-white fw-bold"><?php echo e($settings['site_title'] ?? 'AdminLicence'); ?></h5>
                    </div>
                    <p class="text-muted mb-4"><?php echo e($settings['site_tagline'] ?? 'Système de gestion de licences ultra-sécurisé'); ?></p>
                    <div class="d-flex align-items-center text-success">
                        <i class="fas fa-shield-check me-2"></i>
                        <span class="fw-semibold"><?php echo e($settings['footer_security_badge_text'] ?? 'Chiffrement AES-256'); ?></span>
                    </div>
                </div>
                
                <div class="col-lg-2 col-md-6 mb-4">
                    <h6><?php echo e($settings['footer_product_title'] ?? 'Produit'); ?></h6>
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(route('frontend.home')); ?>"><?php echo e($settings['footer_product_features'] ?? 'Fonctionnalités'); ?></a></li>
                        <li><a href="<?php echo e(route('frontend.about')); ?>"><?php echo e($settings['footer_product_about'] ?? 'À propos'); ?></a></li>
                        <li><a href="<?php echo e(route('frontend.faqs')); ?>">FAQ</a></li>
                    </ul>
                </div>
                
                <div class="col-lg-2 col-md-6 mb-4">
                    <h6><?php echo e($settings['footer_support_title'] ?? 'Support'); ?></h6>
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(route('frontend.contact')); ?>"><?php echo e($settings['footer_support_contact'] ?? 'Contact'); ?></a></li>
                        <li><a href="#"><?php echo e($settings['footer_support_documentation'] ?? 'Documentation'); ?></a></li>
                        <li><a href="#">API</a></li>
                    </ul>
                </div>
                
                <div class="col-lg-4 mb-4">
                    <h6><?php echo e($settings['footer_contact_title'] ?? 'Contact'); ?></h6>
                    ...
                    <?php if($settings['contact_phone']): ?>
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <span><?php echo e($settings['contact_phone']); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="footer-bottom">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <div class="mt-2">
                            <a href="<?php echo e(route('frontend.terms')); ?>" class="text-muted text-decoration-none me-3 small">
                                <?php echo e($settings['footer_terms_text'] ?? 'Termes et Conditions'); ?>

                            </a>
                            <a href="<?php echo e(route('frontend.privacy')); ?>" class="text-muted text-decoration-none small">
    ...
    <div class="position-fixed top-0 start-0 w-100 bg-warning text-center py-2 text-dark fw-bold" style="z-index: 9999;">
        ...
        <a href="<?php echo e(url('/admin/cms/templates')); ?>" class="text-dark">Retour aux templates</a>
    </div>
    <?php endif; ?>

    <?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html> <?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\frontend\templates\professional\layout.blade.php ENDPATH**/ ?>