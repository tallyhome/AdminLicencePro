...
<?php $__env->startSection('title', 'Nouvelle Licence'); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Nouvelle Licence</h1>
        <a href="<?php echo e(route('client.licenses.index')); ?>" class="btn btn-secondary btn-sm">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('client.licenses.store')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                            id="type" name="type">
                                        <option value="single" <?php echo e(old('type', 'single') == 'single' ? 'selected' : ''); ?>>Unique (1 domaine)</option>
                                        <option value="multi" <?php echo e(old('type') == 'multi' ? 'selected' : ''); ?>>Multi-domaine</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?php $__errorArgs = ['allowed_domains'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      placeholder="example.com&#10;subdomain.example.com&#10;(un domaine par ligne)"><?php echo e(old('allowed_domains')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?php echo e(route('client.licenses.index')); ?>" class="btn btn-secondary ml-2">
                                Annuler
                            </a>
                        </div>
                    </form>
...
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\client\licenses\create.blade.php ENDPATH**/ ?>