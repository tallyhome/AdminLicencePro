...
<head>
    ...
    <title><?php echo e(config('app.name', 'AdminLicence')); ?> - Vérification 2FA</title>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            ...
            <div class="mt-6 pt-4 border-t border-gray-200">
                ...
                <a href="<?php echo e(route('admin.2fa.recovery')); ?>" class="text-sm text-indigo-600 hover:text-indigo-500">
...
</html><?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\auth\admin-2fa.blade.php ENDPATH**/ ?>