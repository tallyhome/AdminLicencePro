...
<head>
    ...
    <title>Dashboard Client - <?php echo e(config('app.name')); ?></title>
        ...
        <nav>
            ...
            <div class="mt-5 p-3">
                ...
                <div class="mb-3">
                    ...
                    <strong><?php echo e($client->email); ?></strong>
                </div>
                <?php endif; ?>
                ...
                <div class="col-12">
                    <div class="welcome-card card">
                        <div class="card-body p-4">
                            <h2 class="mb-2">Bienvenue<?php echo e($client ? ', ' . $client->first_name : ''); ?> ! 👋</h2>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h3 class="mb-0"><?php echo e($usageStats['projects']['count'] ?? 0); ?></h3>
                                    <small class="text-muted">
                                        <?php if(($usageStats['projects']['limit'] ?? 0) > 0): ?>
                                            sur <?php echo e($usageStats['projects']['limit']); ?>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h3 class="mb-0"><?php echo e($usageStats['licenses']['count'] ?? 0); ?></h3>
                                    <small class="text-muted">
                                        <?php if(($usageStats['licenses']['limit'] ?? 0) > 0): ?>
                                            sur <?php echo e($usageStats['licenses']['limit']); ?>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h3 class="mb-0"><?php echo e($usageStats['active_licenses'] ?? 0); ?></h3>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h3 class="mb-0"><?php echo e($usageStats['total_activations'] ?? 0); ?></h3>
                        ...
                        <div class="card-body">
                                ...
                                <div class="list-group">
                                    ...
                                    <div class="list-group-item">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="mb-1"><?php echo e($project->name); ?></h6>
                                                <small class="text-muted">
                                            ...
                                            <span class="badge bg-<?php echo e($project->status === 'active' ? 'success' : 'secondary'); ?>">
                                                <?php echo e(ucfirst($project->status ?? 'actif')); ?>
                            ...
                            <?php else: ?>
                                <div class="text-center py-4">
                                    ...
                                    <a href="<?php echo e(route('client.projects.create')); ?>" class="btn btn-primary btn-sm">
                                        Créer un projet
                                    </a>
                                </div>
                            <?php endif; ?>
                        ...
                        <div class="card-body">
                            <?php if($recentLicenses->count() > 0): ?>
                                <div class="list-group">
                                    ...
                                    <div class="list-group-item">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="mb-1"><?php echo e(substr($license->serial_key, 0, 20)); ?>...</h6>
                                                <small class="text-muted">
                                                    Créée <?php echo e($license->created_at->diffForHumans()); ?>

                                                </small>
                                            </div>
                                            <span class="badge bg-<?php echo e($license->status === 'active' ? 'success' : 'secondary'); ?>">
                                                <?php echo e(ucfirst($license->status ?? 'active')); ?>
                            ...
                            <?php else: ?>
                                <div class="text-center py-4">
                                    ...
                                    <a href="<?php echo e(route('client.licenses.create')); ?>" class="btn btn-primary btn-sm">
                                        Générer une licence
                                    </a>
                                </div>
                            <?php endif; ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <h5><?php echo e($subscription->plan->name ?? 'Inconnu'); ?></h5>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <h5><?php echo e($subscription->ends_at ? $subscription->ends_at->format('d/m/Y') : 'N/A'); ?></h5>
                                </div>
                            </div>
                        </div>
                    </div>
...
</html> <?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\client\dashboard-simple.blade.php ENDPATH**/ ?>