                        ...
                        <div class="row">
                            <div class="col-lg-5 d-none d-lg-block">
                                <div class="p-5 bg-gradient-primary text-white d-flex flex-column justify-content-center h-100">
                                    <h2 class="mb-4">Rejoignez <?php echo e(config('app.name')); ?></h2>
                            ...
                            <div class="col-lg-7">
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="<?php echo e(route('client.register')); ?>" id="registerForm">
                                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="step-content" id="step-2" style="display: none;">
                                            <div class="mb-3">
                                                <input type="text" 
                                                       name="company_name" 
                                                       class="form-control form-control-user <?php $__errorArgs = ['company_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <input type="text" 
                                                           name="phone" 
                                                           class="form-control form-control-user <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="mb-3">
                                                <input type="text" 
                                                       name="address" 
                                                       class="form-control form-control-user <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-8 mb-3">
                                                    <input type="text" 
                                                           name="city" 
                                                           class="form-control form-control-user <?php $__errorArgs = ['city'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <input type="text" 
                                                           name="postal_code" 
                                                           class="form-control form-control-user <?php $__errorArgs = ['postal_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="step-content" id="step-3" style="display: none;">
                                            ...
                                            <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="plan-card mb-3 p-3 rounded" data-plan-id="<?php echo e($plan->id); ?>">
                                                    <div class="d-flex align-items-center">
                                                        <input class="form-check-input me-3" 
                                                               ...
                                                               <?php echo e($plan->price == 0 ? 'checked' : ''); ?>
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <div class="d-flex justify-content-between align-items-start">
                                                                <div>
                                                                    ...
                                                                    <p class="text-muted mb-2 small"><?php echo e($plan->description); ?></p>
                                                                        ...
                                                                        <div class="d-flex flex-wrap gap-2">
                                                                            <?php $__currentLoopData = array_slice($plan->features, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <span class="badge bg-success bg-opacity-10 text-success">
                                                                                    <i class="fas fa-check me-1"></i><?php echo e($feature); ?>
                                                                ...
                                                                <div class="text-end">
                                                                    <div class="h5 mb-0">
                                                                        <?php if($plan->price > 0): ?>
                                                                            ...
                                                                            <small class="text-muted d-block">
                                                                                /<?php echo e($plan->billing_cycle === 'yearly' ? 'an' : 'mois'); ?>
                                                                    ...
                                                                    <?php if($plan->trial_days > 0): ?>
                                                                        <small class="badge bg-info">
                                                                            <?php echo e($plan->trial_days); ?> jours d'essai
                                                                        </small>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                <div class="text-danger text-center mb-3"><?php echo e($message); ?></div>
                                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-check mb-4">
                                                <input type="checkbox" 
                                                       name="terms_accepted" 
                                                       class="form-check-input <?php $__errorArgs = ['terms_accepted'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                                ...
                                                <label class="form-check-label small" for="terms_accepted">
                                                    J'accepte les 
                                                    <a href="<?php echo e(route('frontend.terms')); ?>" target="_blank">conditions d'utilisation</a> 
                                                    et la 
                                                    <a href="<?php echo e(route('frontend.privacy')); ?>" target="_blank">politique de confidentialité</a>
                                                </label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="text-center">
                                        <p class="small text-muted">
                                            ...
                                            <a href="<?php echo e(route('client.login.form')); ?>" class="text-decoration-none">
                                                Se connecter
                                            </a>
                                        </p>
                                    </div>
...
</html> <?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\auth\client-register.blade.php ENDPATH**/ ?>