<?php $__env->startSection('title', 'Gestion des templates d\'email'); ?>
            ...
            <form action="<?php echo e(route('admin.email.templates.store')); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">
                        Utilisez les variables dynamiques sous la forme <?php echo e(variable); ?>. Par exemple: <?php echo e(nom); ?>, <?php echo e(email); ?>, etc.
                    </small>
                </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\admin\email\templates.blade.php ENDPATH**/ ?>