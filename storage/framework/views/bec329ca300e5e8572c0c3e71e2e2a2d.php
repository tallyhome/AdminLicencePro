...
<?php $__env->startSection('title', 'Gestion du Frontend'); ?>
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="<?php echo e(route('admin.settings.frontend.preview')); ?>" class="btn btn-info me-2" target="_blank">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.settings.frontend.update-texts')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="app_name" name="app_name" 
                                   value="<?php echo e(old('app_name', $frontendSettings['app_name'])); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="app_tagline" class="form-label">Slogan</label>
                            <input type="text" class="form-control" id="app_tagline" name="app_tagline" 
                                   value="<?php echo e(old('app_tagline', $frontendSettings['app_tagline'])); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="hero_title" name="hero_title" 
                                   value="<?php echo e(old('hero_title', $frontendSettings['hero_title'])); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="hero_subtitle" name="hero_subtitle" 
                                      rows="2" placeholder="Description sous le titre principal"><?php echo e(old('hero_subtitle', $frontendSettings['hero_subtitle'])); ?></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="footer_text" class="form-label">Texte du pied de page</label>
                            <input type="text" class="form-control" id="footer_text" name="footer_text" 
                                   value="<?php echo e(old('footer_text', $frontendSettings['footer_text'])); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="contact_email" name="contact_email" 
                                   value="<?php echo e(old('contact_email', $frontendSettings['contact_email'])); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="contact_phone" name="contact_phone" 
                                   value="<?php echo e(old('contact_phone', $frontendSettings['contact_phone'])); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="contact_address" name="contact_address" 
                                      rows="2" placeholder="123 Rue Example, 75001 Paris, France"><?php echo e(old('contact_address', $frontendSettings['contact_address'])); ?></textarea>
                        </div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.settings.frontend.update-colors')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <input type="color" class="form-control form-control-color" id="primary_color" 
                                       name="primary_color" value="<?php echo e($frontendSettings['primary_color']); ?>">
                                <div class="color-preview" style="background-color: <?php echo e($frontendSettings['primary_color']); ?>"></div>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <input type="color" class="form-control form-control-color" id="secondary_color" 
                                       name="secondary_color" value="<?php echo e($frontendSettings['secondary_color']); ?>">
                                <div class="color-preview" style="background-color: <?php echo e($frontendSettings['secondary_color']); ?>"></div>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <input type="color" class="form-control form-control-color" id="success_color" 
                                       name="success_color" value="<?php echo e($frontendSettings['success_color']); ?>">
                                <div class="color-preview" style="background-color: <?php echo e($frontendSettings['success_color']); ?>"></div>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <input type="color" class="form-control form-control-color" id="danger_color" 
                                       name="danger_color" value="<?php echo e($frontendSettings['danger_color']); ?>">
                                <div class="color-preview" style="background-color: <?php echo e($frontendSettings['danger_color']); ?>"></div>
                            </div>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.settings.frontend.update-social')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="social_facebook" name="social_facebook" 
                                   value="<?php echo e(old('social_facebook', $frontendSettings['social_facebook'])); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="social_twitter" name="social_twitter" 
                                   value="<?php echo e(old('social_twitter', $frontendSettings['social_twitter'])); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="social_linkedin" name="social_linkedin" 
                                   value="<?php echo e(old('social_linkedin', $frontendSettings['social_linkedin'])); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="social_github" name="social_github" 
                                   value="<?php echo e(old('social_github', $frontendSettings['social_github'])); ?>"
    ...
    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="text-center mb-3">
                                <img src="<?php echo e($frontendSettings['logo_url']); ?>" alt="Logo actuel" class="image-preview">
                            </div>
                            <form action="<?php echo e(route('admin.settings.frontend.update-image')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                        ...
                        <div class="col-md-4 mb-4">
                            <h5>Image Hero</h5>
                            <div class="text-center mb-3">
                                <img src="<?php echo e($frontendSettings['hero_image_url']); ?>" alt="Image hero actuelle" class="image-preview">
                            </div>
                            <form action="<?php echo e(route('admin.settings.frontend.update-image')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                        ...
                        <div class="col-md-4 mb-4">
                            <h5>Favicon</h5>
                            <div class="text-center mb-3">
                                <img src="<?php echo e($frontendSettings['favicon_url']); ?>" alt="Favicon actuel" class="image-preview" style="max-width: 64px;">
                            </div>
                            <form action="<?php echo e(route('admin.settings.frontend.update-image')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
        ...
        <div class="col-lg-4 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.settings.frontend.update-features')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <div class="feature-toggle">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="show_hero_section" 
                                       name="show_hero_section" <?php echo e($frontendSettings['show_hero_section'] ? 'checked' : ''); ?>>
                        ...
                        <div class="feature-toggle">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="show_features_section" 
                                       name="show_features_section" <?php echo e($frontendSettings['show_features_section'] ? 'checked' : ''); ?>>
                        ...
                        <div class="feature-toggle">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="show_contact_section" 
                                       name="show_contact_section" <?php echo e($frontendSettings['show_contact_section'] ? 'checked' : ''); ?>>
                        ...
                        <div class="feature-toggle">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="maintenance_mode" 
                                       name="maintenance_mode" <?php echo e($frontendSettings['maintenance_mode'] ? 'checked' : ''); ?>>
                            ...
                            <div class="mt-2">
                                <input type="text" class="form-control" name="maintenance_message" 
                                       value="<?php echo e($frontendSettings['maintenance_message']); ?>"
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('admin.settings.frontend.preview')); ?>" class="btn btn-info" target="_blank">
                    ...
                    <form id="reset-form" action="<?php echo e(route('admin.settings.frontend.reset')); ?>" method="POST" style="display: none;">
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\admin\settings\frontend.blade.php ENDPATH**/ ?>