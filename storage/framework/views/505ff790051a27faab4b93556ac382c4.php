<?php $__env->startSection('title', 'Modifier FAQ'); ?>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.cms.faqs.update', $faq)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="question" name="question" value="<?php echo e(old('question', $faq->question)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                          id="answer" name="answer" rows="6" required><?php echo e(old('answer', $faq->answer)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="category" name="category" value="<?php echo e(old('category', $faq->category)); ?>" list="categories">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="sort_order" name="sort_order" value="<?php echo e(old('sort_order', $faq->sort_order)); ?>" min="0" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" 
                                           value="1" <?php echo e(old('is_featured', $faq->is_featured) ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                           value="1" <?php echo e(old('is_active', $faq->is_active) ? 'checked' : ''); ?>>
                        ...
                        <div class="text-end">
                            <a href="<?php echo e(route('admin.cms.faqs.show', $faq)); ?>" class="btn btn-light me-2">Annuler</a>
                ...
                <div class="card-body">
                    <div class="alert alert-secondary mb-0">
                        ...
                        <ul class="mb-0 small">
                            ...
                            <?php endif; ?>
                            <?php if($faq->views_count): ?>
                                <li><strong>Vues :</strong> <?php echo e($faq->views_count); ?></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\admin\cms\faqs\edit.blade.php ENDPATH**/ ?>