...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?php echo e(route('client.projects.index')); ?>" class="btn btn-secondary btn-sm">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('client.projects.store')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      placeholder="Description du projet..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="version" name="version" value="<?php echo e(old('version', '1.0.0')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?php echo e(route('client.projects.index')); ?>" class="btn btn-secondary ml-2">
                                Annuler
                            </a>
                        </div>
                    </form>
...
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\client\projects\create.blade.php ENDPATH**/ ?>