...
<div class="container-fluid py-4">
    ...
    <div class="card bg-primary text-white mb-4">
        <div class="card-body p-4">
            ...
            <p class="mb-0">Bienvenue, <?php echo e(auth('client')->user()->name); ?> ! Voici un aperçu de votre activité.</p>
        </div>
    </div>
    ...
    <?php if(count($notifications) > 0): ?>
        <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="alert alert-<?php echo e($notification['type']); ?> d-flex align-items-center mb-4" role="alert">
                <i class="<?php echo e($notification['icon']); ?> me-3"></i>
                <div class="flex-grow-1">
                    <h6 class="alert-heading mb-1"><?php echo e($notification['title']); ?></h6>
                    <p class="mb-0"><?php echo e($notification['message']); ?></p>
                </div>
                <?php if(isset($notification['action'])): ?>
                    <a href="<?php echo e($notification['action']['url']); ?>" class="btn btn-<?php echo e($notification['type']); ?> btn-sm ms-3">
...
<script>
    ...
    const licensesChart = new Chart(ctx, {
        type: 'line',
        data: <?php echo json_encode($chartsData); ?>,
        options: {
            responsive: true,
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views/client/dashboard.blade.php ENDPATH**/ ?>