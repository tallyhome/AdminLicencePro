<?php $__env->startSection('title', t('email.title')); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><?php echo e(t('email.title')); ?></h1>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><?php echo e(t('email.settings')); ?></h3>
        </div>
        <div class="card-body">
            <form action="<?php echo e(route('admin.mail.settings.store')); ?>" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <!-- Driver -->
                        <div class="mb-3">
                            <label for="mail_driver" class="form-label"><?php echo e(t('email.driver')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Host -->
                        <div class="mb-3">
                            <label for="mail_host" class="form-label"><?php echo e(t('email.host')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Port -->
                        <div class="mb-3">
                            <label for="mail_port" class="form-label"><?php echo e(t('email.port')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Encryption -->
                        <div class="mb-3">
                            <label for="mail_encryption" class="form-label"><?php echo e(t('email.encryption')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <!-- Username -->
                        <div class="mb-3">
                            <label for="mail_username" class="form-label"><?php echo e(t('email.username')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Password -->
                        <div class="mb-3">
                            <label for="mail_password" class="form-label"><?php echo e(t('email.password')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- From Address -->
                        <div class="mb-3">
                            <label for="mail_from_address" class="form-label"><?php echo e(t('email.from_address')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- From Name -->
                        <div class="mb-3">
                            <label for="mail_from_name" class="form-label"><?php echo e(t('email.from_name')); ?></label>
