...
<div class="bg-light min-vh-100">
    ...
    <div class="hero-section-compact text-center py-4">
        <div class="container">
            ...
            <a href="<?php echo e(route('documentation.index')); ?>" class="btn btn-light btn-sm fw-semibold">
            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-actions mt-4">
                    ...
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('documentation.index')); ?>" class="btn btn-primary btn-sm">
                ...
                <div class="content-navigation mt-5 pt-4 border-top bg-light rounded p-4">
                    <div class="row">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <a href="<?php echo e(route('documentation.index')); ?>" class="btn btn-primary btn-lg w-100">
...
<?php echo $__env->make($layout ?? 'frontend.templates.modern.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\documentation\api.blade.php ENDPATH**/ ?>