...
<?php $__env->startSection('title', 'Ajouter une méthode de paiement'); ?>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo e(route('client.payment-methods.index')); ?>" class="btn btn-secondary btn-sm">
...
document.getElementById('stripeSubmit').addEventListener('click', function() {
    ...
    fetch('<?php echo e(route("client.payment-methods.store")); ?>', {
        method: 'POST',
        body: formData
    })
    ...
    .then(data => {
        if (data.success) {
            window.location.href = '<?php echo e(route("client.payment-methods.index")); ?>';
        } else {
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\client\payment-methods\create.blade.php ENDPATH**/ ?>