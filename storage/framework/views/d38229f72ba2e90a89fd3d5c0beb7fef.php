<?php $__env->startSection('title', t('email.providers.phpmail.title')); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col">
            <h1 class="h3"><?php echo e(t('email.providers.phpmail.title')); ?></h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-8 mb-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"><?php echo e(t('email.providers.phpmail.settings')); ?></h5>
                    <form action="<?php echo e(route('admin.mail.providers.phpmail.update')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        
                        <div class="mb-3">
                            <label for="from_address" class="form-label"><?php echo e(t('email.from_address')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            <label for="from_name" class="form-label"><?php echo e(t('email.from_name')); ?></label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="card-title"><?php echo e(t('email.providers.phpmail.statistics')); ?></h5>
                    
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            <h6 class="mb-0"><?php echo e(t('email.providers.phpmail.emails_sent_today')); ?></h6>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="mb-0"><?php echo e(t('email.providers.phpmail.emails_sent_month')); ?></h6>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"><?php echo e(t('email.providers.phpmail.logs')); ?></h5>
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <form action="<?php echo e(route('admin.mail.providers.phpmail.logs.clear')); ?>" method="POST" class="d-inline">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="btn btn-danger btn-sm">
                                <i class="fas fa-trash me-2"></i> <?php echo e(t('email.providers.phpmail.clear_logs')); ?>
                    ...
                    <div class="logs-container" style="max-height: 300px; overflow-y: auto;">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <p class="text-muted mb-0"><?php echo e(t('email.providers.phpmail.no_logs_available')); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\admin\mail\providers\phpmail\index.blade.php ENDPATH**/ ?>