...
<?php $__env->startSection('title', 'Gestionnaire de Médias'); ?>
...
<div class="container-fluid">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white border-0 pb-0">
            <h5 class="mb-0">Galerie des médias (<?php echo e(count($medias)); ?> fichiers)</h5>
        </div>
        <div class="card-body">
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                        <div class="card media-item h-100 border-0 shadow-sm">
                            <div class="card-img-top bg-light d-flex align-items-center justify-content-center" style="height: 150px;">
                                <?php if(in_array(strtolower(pathinfo($media['name'], PATHINFO_EXTENSION)), ['jpg', 'jpeg', 'png', 'gif', 'svg'])): ?>
                                    <img src="<?php echo e($media['url']); ?>" alt="<?php echo e($media['name']); ?>" class="img-fluid rounded" style="max-height: 140px; max-width: 100%; object-fit: cover;">
                                <?php else: ?>
                                    <i class="fas fa-file fa-3x text-muted"></i>
                                <?php endif; ?>
                            </div>
                            <div class="card-body p-2">
                                <h6 class="card-title mb-1 text-truncate" title="<?php echo e($media['name']); ?>"><?php echo e($media['name']); ?></h6>
                                <small class="text-muted d-block"><?php echo e(number_format($media['size'] / 1024, 1)); ?> KB</small>
                                <div class="d-flex gap-1 mt-2">
                                    <button class="btn btn-sm btn-outline-primary copy-url-btn" data-url="<?php echo e($media['url']); ?>">
                                        <i class="fas fa-copy"></i>
                                    </button>
                                    <a href="<?php echo e($media['url']); ?>" target="_blank" class="btn btn-sm btn-outline-info">
                                        <i class="fas fa-external-link-alt"></i>
                                    </a>
                                    <button class="btn btn-sm btn-outline-danger delete-media-btn" data-filename="<?php echo e($media['name']); ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleFiles(files) {
        ...
        Array.from(files).forEach((file) => {
            ...
            fetch('<?php echo e(route("admin.cms.upload-image")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
    ...
    document.querySelectorAll('.delete-media-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            if (confirm('Supprimer ce fichier ?')) {
                fetch('<?php echo e(route("admin.cms.delete-media")); ?>', {
                    method: 'DELETE',
                    headers: {
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\AdminLicence-4.5.1\resources\views\admin\cms\media\index.blade.php ENDPATH**/ ?>